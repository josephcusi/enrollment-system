                            ...
                            <div class="col-md-12">
                                <div class="tab-content">
                                    <div class="active tab-pane" id="basic_info">
                                           <form action="<?=base_url('insert_subject')?>" method="post">
                                                ...
                                                <table id="example1" class="table table-bordered table-striped"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td><input type="checkbox" name="subject_id[]"
                                                           ...
                                                           <td style="display: none;"><input type="hidden" name="lrn" value="<?=$userName[0]['lrn']?>"></td>
                                                           <td style="display: none;"><input type="hidden" name="year" value="<?=$year['year']?>"></td>
                                                           <td style="display: none;"><input type="hidden" name="semester" value="<?=$year['semester']?>"></td>
                                                        </tr>
                                                        <?php endforeach;?>
                                                    </tbody>
                                                </table>
