        ...
        <aside class="main-sidebar sidebar-dark-secondary elevation-8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="<?=base_url()?>/dist/img/user8-128x128.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        ...
                        <div class="card">
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#basic_info"
                                            data-toggle="tab">Basic
                                            Information</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#credential"
                                            data-toggle="tab">Credential</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#address"
                                            data-toggle="tab">Address</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#guardian"
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                                ...
                                                <form class="form-horizontal" action="insertProfile" method="post">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select class="form-control" id="inputGender" name="gender"
                                                                ...
                                                                <option type="text" class="form-control"
                                                                    id="inputGender">Male</option>
                                                                <option type="text" class="form-control"
                                                                    id="inputGender">Female</option>
                                                            </select>
                                                            <span class="text-danger">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select class="form-control" id="inputCivil"
                                                                name="civil_status"
                                                                value="<?= isset($profile['civil_status']) ? $profile['civil_status'] : '' ; ?>">
                                                                <option type="text" class="form-control"
                                                                    id="inputCivil">Single</option>
                                                                <option type="text" class="form-control"
                                                                    id="inputCivil">Married</option>
                                                                <option type="text" class="form-control"
                                                                    id="inputCivil">Divorced</option>
                                                                <option type="text" class="form-control"
                                                                    id="inputCivil">Separated</option>
                                                            </select>
                                                            <span class="text-danger">
                                    ...
                                    <div class="tab-pane" id="address">
                                        ...
                                        <br>
                                        <div class="form-group row">
                                            <label for="contact" class="col-sm-1 col-form-label">Provincial
                                                Address</label>
                                            <div class="col-sm-5">
                                    ...
                                    <div class="tab-pane" id="education">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="contact" name="elem_address"
                                                    placeholder="Address"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="school_name"
                                                    name="high_school" placeholder="School Name"
                                        ...
                                        <div class="form-group row">
                                            <label for="address" class="col-sm-1 col-form-label">Address</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="address" name="high_address"
                                                    placeholder="Address"
                                        ...
                                        <div class="form-group row">
                                            <label for="year" class="col-sm-1 col-form-label">Year Attendee</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" id="year" name="high_year"
                                                    placeholder="Year attendee"
