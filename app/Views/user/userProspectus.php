                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-primary card-outline" style="">
                            <div class="card-body box-profile">
                                ...
                                <p class="text-muted text-left" style="font-family:poppins;">Program</p>
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table" style="font-family:poppins">
                                    ...
                                    <tbody>
                                        <?php 
                                            $ids = array_combine(
                                                explode(',', $subject['subject_id']),
                                                array_map(function($grade, $remark) {
                                                    return [
                                                        'grade' => $grade,
                                                        'remark' => $remark,
                                                    ];
                                                }, explode(',', $subject['subject_grade']), explode(',', $subject['subject_remark']))
                                            );
                                        ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if ($ids[$stdnt_sjct['id']]['remark'] == '1'):?>
                                            <td>PASSED</td>
                                            <?php else:?>
                                            <td>FAILED</td>
                                        </tr>                                            
                                        ...
                                        <tr>
                                            <th>Total Grade:</th>
                                            <td><?= $subject['total_grading']?></td>
                                            <?php if($subject['overall_remark'] == '1'):?>
                                            <td>PASSED</td>
                                            <?php else:?>
                                            <td>FAILED</td>
                                            <?php endif;?>
