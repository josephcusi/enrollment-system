  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="<?=base_url('/landing')?>"><img src="<?=base_url()?>/cssjs/img/bccLogo.png" alt="dormehi Logo" class="brand-image img-circle elevation-3" style="opacity: 10;width:65px;">
    ...
    <div class="best-features">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>About Baco Community College</h2>
            </div>
          </div>
          <div class="col-md-6">
            <div class="left-content">
              <h4>Looking for the best school?</h4>
          ...
          <div class="col-md-6">
            <div class="right-image">
              <img src="<?=base_url()?>/webpage/assets/images/feature-image.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
