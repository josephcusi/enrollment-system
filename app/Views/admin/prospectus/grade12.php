          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline" style = "">
              <div class="card-body box-profile">
                ...
                <li class="nav-item"><a type="button" class="tablinks nav-link <?php if($strand == 'gas'){echo 'active' ;} ?>"style = "border-radius:20px" id="defaultOpen" href="<?= base_url('strandProspectus12/'.'gas')?>">GAS</a></li>
                    <li class="nav-item"><a type="button" class="tablinks nav-link <?php if($strand == 'smaw'){echo 'active';} ?>"style = "border-radius:20px" id="defaultOpen "  href="<?= base_url('strandProspectus12/'.'smaw')?>">SMAW</a></li>
                  </ul>
              </div>
              <!-- /.card-body -->
            </div>
