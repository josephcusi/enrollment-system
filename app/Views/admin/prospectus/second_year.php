      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open"style = "font-family:poppins;">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="/prospectus12" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>2nd Year</p>
                  </a>
                </li>
            ...
            <div class="card card-primary card-outline" style = "">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3 nav nav-pills">
                  ...
                  <li class="nav-item"><a type="button" class="tablinks nav-link <?php if($strand == 'abh'){echo 'active';} ?>"style = "border-radius:20px" id="defaultOpen "  href="<?= base_url('strandProspectus12/'.'abh')?>">ABH</a></li>
                  <li class="nav-item"><a type="button" class="tablinks nav-link <?php if($strand == 'bpa'){echo 'active' ;} ?>"style = "border-radius:20px" id="defaultOpen" href="<?= base_url('strandProspectus12/'.'bpa')?>">BPA</a></li>
                  <li class="nav-item"><a type="button" class="tablinks nav-link <?php if($strand == 'btvted'){echo 'active' ;} ?>"style = "border-radius:20px" id="defaultOpen" href="<?= base_url('strandProspectus12/'.'btvted')?>">BTVTED</a></li>
                  </ul>
              </div>
              <!-- /.card-body -->
            </div>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      >update</button></a>
                       <?= $this->include('admin/prospectus/updateprospectussecond')?>
                    </td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
          ...
          <div class="modal-content">
            ...
            <?= csrf_field(); ?>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <option type="text" class="form-control" id="year_level" placeholder="Year Level" value="2nd Year">2nd Year</option>
