  ...
  <body class="hold-transition sidebar-mini layout-fixed">
             ...
             with font-awesome or any other icon font library -->
                          ...
                          <li class="nav-item" style="font-family:poppins;">
                              ...
                              <ul class="nav nav-treeview">
                                  ...
                                  <li class="nav-item">
                                      <a href="<?= base_url('prospectus11/' . $year_levelThird['id'])?>"
                                          class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>3rd Year</p>
                                      </a>
                          ...
                          <li class="nav-item" style="font-family:poppins;">
                              ...
                              <ul class="nav nav-treeview">
                                  ...
                                  <li class="nav-item">
                                      <a href="<?= site_url('StudentGrading/' . $year_levelTwo['id'])?>"
                                          class="nav-link">
                                          <i class="far fa-circle nav-icon"></i>
                                          <p>Grade 12</p>
                                      </a>
      ...
      <div class="content-wrapper">
          ...
          <script>
          swal("Rejected!", "Registration successfully rejected.", "success");
          </script>
          <?php endif ?>
          <?php if(!empty(session()->getFlashdata('enrolled'))) : ?>
          <script>
          swal("Enrolled!", "Registration has been successfully enrolled.", "success");
          </script>
          <?php endif ?>
                      ...
                      <table id="example1" class="table table-bordered table" style="font-family:poppins">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="<?=base_url('viewPreEnroll/'. $pre_enrolled_value['id'] )?>"><button
