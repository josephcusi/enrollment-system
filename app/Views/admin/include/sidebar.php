<aside class="main-sidebar sidebar-dark-secondary elevation-8">
  ...
  <a href="index3.html" class="brand-link">
    ...
    <span class="brand-text font-weight-light" style="margin-left:10%;"><strong>Baco Community College</strong></span>
  </a>
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <li class="nav-item">
              <a href="<?=base_url('/pre_enrolled')?>" class="nav-link">
        ...
        <li class="nav-item">
            <li class="nav-item">
              <a href="<?=base_url('/prospectus')?>" class="nav-link">
                <i class="far fa-thin fa-newspaper"></i>
                <p>Prospectus</p>
              </a>
            </li>
