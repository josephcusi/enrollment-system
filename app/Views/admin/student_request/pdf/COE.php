...
<body>
    <div class="container">
        ...
        <br>
        <br>
        <h2 style="font-size:19px;text-align: left;">TO WHOM IT MAY CONCERN:</h2>
        <p align="justify"><span style="color:white;">------</span><span style="font-weight: bold;">This is to
                certify</span> that <span style="font-weight: bold;">Mr./Ms.
                <?=$coe['firstname'] .' ' . $coe['middlename'] . ' ' . $coe['lastname'] ?></span> is enrolled at Baco
            Community College, <?=$coe['semester']?>, F.Y. <?=$coe['year']?>.</p>
        <p align="justify"><span style="color:white;">------</span>Certified further, that the aboved-name is a
            <?=$coe['year_level']?> student taking up <?=$coe['title']?>.</p>
