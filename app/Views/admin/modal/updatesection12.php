...
<div class="modal-body">
  <form action="<?= site_url('section_update12') ?>" method="post">
...
<?= csrf_field(); ?>
  ...
  <div class="form-group col-sm-6 mx-auto">
    ...
    <input type="text" name="section" class="form-control sectionModal" id="inputSection" placeholder="Section" required>
