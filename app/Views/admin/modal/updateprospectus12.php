...
<form action="<?= base_url('updateProspectus12'); ?>" method="post">
...
<?= csrf_field(); ?>
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" name="title" class="form-control subject_titleModal" id="inputTitle" placeholder="Title">
        <span class="text-danger">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" name="unit" class="form-control unitModal" id="inputUnit" placeholder="Unit">
        <span class="text-danger">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" name="pre_requisit" class="form-control pre_requisitModel" id="PreRequisit" placeholder="Pre-Requisit">
        <span class="text-danger">
