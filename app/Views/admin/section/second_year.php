                            ...
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3 nav nav-pills">
                                    ...
                                    <li class="nav-item"><a type="button"
                                            ...
                                            href="<?= base_url('strandSec11/'. $year_levelTwo['id'] . '/' . 'GAS')?>">GAS</a>
                                    </li>
                                    <li class="nav-item"><a type="button"
                                            class="tablinks nav-link <?php if($strand == 'SMAW'){echo 'active';} ?>"
                                            style="border-radius:20px" id="defaultOpen "
                                            href="<?= base_url('strandSec11/'. $year_levelTwo['id'] . '/' . 'SMAW')?>">SMAW</a>
                                    </li>
                                    <?php else:?>
                                    <?php $strand = session()->getFlashdata('strand');?>
                                    <li class="nav-item"><a type="button"
                                            ...
                                            style="border-radius:20px" id="defaultOpen"
                                            href="<?= base_url('strandSec11/'.$year_levelTwo['id'] . '/' .'ABH')?>">ABH</a>
                                    </li>
                                    <li class="nav-item"><a type="button"
                                            class="tablinks nav-link <?php if($strand == 'BPA'){echo 'active' ;} ?>"
                                            style="border-radius:20px" id="defaultOpen"
                                            href="<?= base_url('strandSec11/'.$year_levelTwo['id'] . '/' .'BPA')?>">BPA</a>
                                    </li>
                                    <li class="nav-item"><a type="button"
                                            class="tablinks nav-link <?php if($strand == 'BTVTED'){echo 'active' ;} ?>"
                                            style="border-radius:20px" id="defaultOpen"
                                            href="<?= base_url('strandSec11/'.$year_levelTwo['id'] . '/' .'BTVTED')?>">BTVTED</a>
                                    </li>
                                    <?php endif;?>
                                </ul>
                                </ul>
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="<?=base_url('schedule11/'. $year_levelTwo['id'] . '/' . $section_value['id'])?>"><button
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select class="form-control" id="studentStrand"
                                                                    ...
                                                                    <option type="text" class="form-control"
                                                                        ...
                                                                        value="<?=$year_levelTwo['year_level']?>">
                                                                        <?=$year_levelTwo['year_level']?></option>
