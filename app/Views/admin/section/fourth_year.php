                            ...
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3 nav nav-pills">
                                    ...
                                    <li class="nav-item"><a type="button"
                                            ...
                                            href="<?= base_url('courseFourthyear/'.'abh')?>">ABH</a></li>
                                    <li class="nav-item"><a type="button"
                                            class="tablinks nav-link <?php if($strand == 'bpa'){echo 'active' ;} ?>"
                                            style="border-radius:20px" id="defaultOpen"
                                            href="<?= base_url('courseFourthyear/'.'bpa')?>">BPA</a></li>
                                    <li class="nav-item"><a type="button"
                                            class="tablinks nav-link <?php if($strand == 'btvted'){echo 'active' ;} ?>"
                                            style="border-radius:20px" id="defaultOpen"
                                            href="<?= base_url('courseFourthyear/'.'btvted')?>">BTVTED</a></li>
                                </ul>
                                </ul>
                            </div>
                            <!-- /.card-body -->
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?=base_url('schedule4th/'. $section_value['id'])?>"><button
                                                            ...
                                                            <?= $this->include('admin/section/updatesectionfourth')?>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <?php endforeach;?>
