<div class="modal fade" id="addSchedule">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?php if(empty($sched[0]['section_id'])):?>
                <form class="form-horizontal" action="<?= site_url('addsched11/'. $id);?>" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <label for="friday" class="col-sm-6 col-form-label">Saturday</label>
                            <input type="time" name="satOne" class="form-control" value="">

                        </div>
                        <div class="form-group col-sm-6 mx-auto">

                            <label for="" class="col-sm-6 col-form-label"> <br></label>
                            <input type="time" name="satTwo" class="form-control" value="">
                ...
                <?php else:?>
                    <form class="form-horizontal" action="<?= site_url('addedscheduling');?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="form-row mt-3">
                    <input type="hidden" class="sched_id" name="sched_id">
                        <input type="hidden" class="id" name="id">
                        <div class="form-group col-sm-6 mx-auto">
                            <label for="teacher" class="col-sm-6 col-form-label">Teacher</label>
                            <select class="form-control" name="teacher">
