<div class="modal fade" id="updateSched">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?= site_url('updateSched12/'. $id);?>" method="post">
            <?= csrf_field(); ?>
            <div class="form-row mt-3">
              <input type="hidden" class="id" name="id">
                  ...
                  <div class="form-group col-sm-6 mx-auto">
                            ...
                            <input type="text"  class="form-control subject" name="subject" disabled>
